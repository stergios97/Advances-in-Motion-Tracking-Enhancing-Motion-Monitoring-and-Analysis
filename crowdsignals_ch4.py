...
def main():
    ...
    if FLAGS.mode == 'final':
        ...
        ws = int(float(30*1000)/milliseconds_per_instance)
        fs = float(1000)/milliseconds_per_instance
        ...
        dataset = CatAbs.abstract_categorical(dataset, ['label'], ['like'], 0.03, int(float(5*60*1000)/milliseconds_per_instance), 2)
